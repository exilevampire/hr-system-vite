...
const headers = [
  ...
  { header: "วันเริ่มงาน",   note: "วัน/เดือน/ปี พ.ศ." },
  { header: "FMIS",          note: "ดำเนินการแล้ว / ยังไม่ดำเนินการ" },
  { header: "eMeeting",      note: "ดำเนินการแล้ว / ยังไม่ดำเนินการ" },
  { header: "Software",      note: "ดำเนินการแล้ว / ยังไม่ดำเนินการ" },
  { header: "Phonebook",     note: "ดำเนินการแล้ว / ยังไม่ดำเนินการ" },
];
...
// Example rows
const examples = [
  [1, 6, 2568, "15/6/2568", "EMP001", "สมชาย ใจดี", "Somchai Jaidee", "นักวิชาการคอมพิวเตอร์", "ข้าราชการ", "ฝ่ายเทคโนโลยีสารสนเทศ", "สำนักงานบริหารทรัพยากรบุคคล", "30/6/2568", "", "ดำเนินการแล้ว", "ดำเนินการแล้ว", "ยังไม่ดำเนินการ", "ยังไม่ดำเนินการ"],
...
// Column widths
const widths = [14, 8, 8, 18, 14, 22, 22, 22, 14, 22, 28, 16, 14, 18, 12, 12, 12];
headers.forEach((_, i) => {
