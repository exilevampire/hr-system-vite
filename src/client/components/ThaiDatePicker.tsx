    ...
    <div ref={ref} className={`relative ${className}`}>
      <div className="relative">
        <input
          ...
          onClick={() => setOpen(o => !o)}
          className="w-full border border-slate-300 rounded-lg pl-3 pr-8 py-2 text-sm cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
        />
        {value ? (
