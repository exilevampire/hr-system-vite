        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 text-sm text-blue-700 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-blue-600 font-mono">
              ข้อมูลต้นทาง | เดือน | ปี | วันที่ได้รับข้อมูล | รหัสประจำตัว | ชื่อ-สกุล | Name-Eng | ตำแหน่ง | ประเภท | ฝ่าย/กลุ่ม/งาน | หน่วยงาน | วันที่พ้นสภาพ | <span className="text-blue-800 font-semibold">อีเมล</span>
            </p>
